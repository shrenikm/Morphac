...
const Eigen::Vector2d CanvasToWorld(const Eigen::Vector2d& coord,
                                    const double resolution);

const morphac::constructs::Coordinate CanvasToWorld(
    const morphac::constructs::Coordinate& coord, const double resolution);

const Eigen::Vector2d WorldToCanvas(
    const Eigen::Vector2d& coord, const double resolution,
