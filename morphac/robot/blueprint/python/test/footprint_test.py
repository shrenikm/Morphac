...
def generate_circular_footprint_list():
    f1 = Footprint.create_circular_footprint(2., 0.1)
...
def generate_rectangular_footprint_list():
    f1 = Footprint.create_rectangular_footprint(6., 4., 0.)
...
def generate_rounded_rectangular_footprint_list():
    f1 = Footprint.create_rounded_rectangular_footprint(6., 4., 0., 1., 0.1)
...
def generate_triangular_footprint_list():
    f1 = Footprint.create_triangular_footprint(2., 2., 0.)
